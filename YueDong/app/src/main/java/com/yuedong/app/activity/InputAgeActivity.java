...
public class InputAgeActivity extends BaseActivity {
    ...
    private void init() {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                model.Age = Integer.parseInt(mInput.getText().toString());
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            if (!jsonObject.get("ResultCode").toString().equals("1")) {
                                ((BaseApplication) getApplication()).getInstance().CurrentUser.Age = Integer.parseInt(mInput.getText().toString());
                                ((Activity) mContext).finish();
                            } else {
        ...
        mInput.setText(((BaseApplication) getApplication()).CurrentUser.Age + "");
        clear.setVisibility(View.VISIBLE);
    }
}
